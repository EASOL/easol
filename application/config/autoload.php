...
$autoload['libraries'] = array('database','session', 'form_validation', 'gas', 'easol_module', 'easol_logs', 'easol_language');
...
$autoload['helper'] = array('url', 'sql', 'datetime', 'menu', 'form', 'system', 'language');
