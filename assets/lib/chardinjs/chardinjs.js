        ...
        return r = function() {
            ...
            return e.prototype.start = function() {
                ...
                if (this._overlay_visible()) {
                    r = this.$el.find("*[data-intro]:visible"), i = [];
                ...
                var n, r;
                return r = t(e).data("helper_layer"), n = this._get_offset(e), r.setAttribute("style", "width: " + n.width + "px; height:" + n.height + "px; top:" + n.top + "px; left: " + n.left + "px;")
